...
export enum FileFieldsEnum {
  ...
  ChildMarkdownRemarkFrontmatterRating = 'childMarkdownRemark___frontmatter___rating',
...
export enum MarkdownRemarkFieldsEnum {
  ...
  FrontmatterRating = 'frontmatter___rating',
  Excerpt = 'excerpt',
...
export enum SitePageFieldsEnum {
  ...
  PluginCreatorPluginOptionsPublicPath = 'pluginCreator___pluginOptions___publicPath',
  PluginCreatorPluginOptionsHtmlTitle = 'pluginCreator___pluginOptions___htmlTitle',
  PluginCreatorPluginOptionsIncludeRobots = 'pluginCreator___pluginOptions___includeRobots',
...
export enum SitePluginFieldsEnum {
  ...
  PluginOptionsPublicPath = 'pluginOptions___publicPath',
  PluginOptionsHtmlTitle = 'pluginOptions___htmlTitle',
  PluginOptionsIncludeRobots = 'pluginOptions___includeRobots',
...
export type IndexPageQuery = (
  ...
  & { allMarkdownRemark: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'MarkdownRemark' }
        & Pick<MarkdownRemark, 'html' | 'tableOfContents' | 'timeToRead'>
        & { fields: Maybe<(
          { __typename?: 'MarkdownRemarkFields' }
